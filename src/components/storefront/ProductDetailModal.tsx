...
export default function ProductDetailModal({ product, open, onClose, onAddToCart }: ProductDetailModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-lg rounded-card border-border/50 max-h-[90vh] overflow-y-auto p-0">
        {/* Product Image */}
        <div className="aspect-[4/3] bg-muted/50 relative overflow-hidden rounded-t-card">
          {product.photo ? (
